# train_union.csv, val.csv, test.csv, config.py
# Опционально: baseline_metrics.json, cleanlab_metrics.json,
#              datamaps_metrics.json, ds2_metrics.json, intersection_metrics.json
