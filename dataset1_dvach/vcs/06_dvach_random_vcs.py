...
# Читаем N_REMOVE из статистики ver_dedup
...
print(f"\n{'=' * 60}")
print("РЕЗУЛЬТАТЫ НА ТЕСТЕ (РАНДОМНОЕ УДАЛЕНИЕ — VCS)")
print(f"{'=' * 60}")
...
print(f"\n{'=' * 60}")
print("СРАВНЕНИЕ: BASELINE vs DEDUP vs VCS vs RANDOM")
print(f"{'=' * 60}")
...
print(f"\nall_results.json обновлён: добавлен random_ver_dedup")
