# train.csv, val.csv, test.csv, config.py, results_hybrid/hybrid_stats.json
# Опционально: baseline_metrics.json, union_metrics.json
...
for name, path in [("Baseline", "baseline_metrics.json"), ("Union", "union_metrics.json")]:
...
if "union" in comparison:
    un_f1 = comparison["union"]["f1_macro"]
    delta = round(un_f1 - rn_f1, 4)
